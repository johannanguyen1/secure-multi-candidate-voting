...
// Struct that wraps vector of votes
struct Vote_Ciphertext_Wrapper : public Serializable {
  std::vector<Vote_Ciphertext> vote_vector;
...
// Struct that wraps vector of zkps
struct VoteZKP_Wrapper : public Serializable {
  std::vector<VoteZKP_Struct> zkp_vector;
...
struct VoterToTallyer_Vote_Message : public Serializable {
  Vote_Ciphertext_Wrapper vote_wrapper;
  CryptoPP::Integer unblinded_signature;
  VoteZKP_Wrapper zkp_wrapper;
  void serialize(std::vector<unsigned char> &data);
  int deserialize(std::vector<unsigned char> &data);
};
...
struct TallyerToWorld_Vote_Message : public Serializable {
  ...
  CryptoPP::Integer unblinded_signature;
  std::string
      tallyer_signature; // computed on vote_wrapper
...
struct PartialDecryption_Struct : public Serializable {
  std::vector<CryptoPP::Integer> d_vector;
  Vote_Ciphertext_Wrapper aggregate_ciphertext;
